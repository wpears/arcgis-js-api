 ...
 */
//>>built
define("esri/dijit/Print","dojo/_base/declare dojo/_base/lang dojo/_base/connect dojo/_base/array dojo/has dojo/dom dojo/dom-class dojo/dom-construct dijit/Menu dijit/MenuItem dijit/form/Button dijit/form/ComboButton esri/tasks/PrintTask esri/tasks/PrintParameters esri/kernel esri/domUtils esri/Evented dojo/i18n!esri/nls/jsapi".split(" "),function(f,d,l,m,n,p,g,h,q,r,s,t,u,v,w,k,x,y){f=f([x],{declaredClass:"esri.dijit.Print",_eventMap:{"print-complete":["result"],error:!0,"print-start":!0},onPrintComplete:function(){},
