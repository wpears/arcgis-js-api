...
a)this.onDelete();this._updateUI()},_createTools:function(){this._tools.SELECT=new r({settings:this._settings,onClick:a.hitch(this,"_activateTool","SELECT",!0),onFinished:a.hitch(this,"_toolFinished","SELECT")});this.addChild(this._tools.SELECT);this._tools.CLEAR=new b(a.mixin(s.selectClear,{settings:this._settings,onClick:a.hitch(this._settings.editor,"_clearSelection",!1)}));this.addChild(this._tools.CLEAR);this._createSeparator();this._tools.ATTRIBUTES=new b(a.mixin(d.attributes,{settings:this._settings,
onClick:a.hitch(this,"_toolFinished","ATTRIBUTES")}));this.addChild(this._tools.ATTRIBUTES);this._createSeparator();this._tools.EDITING=new q({settings:this._settings,onClick:a.hitch(this,"_activateTool","EDITING",!0),onApplyEdits:a.hitch(this,"onApplyEdits"),onFinished:a.hitch(this,"_toolFinished","EDITING")});this.addChild(this._tools.EDITING);this._tools.DELETE=new b(a.mixin(d.del,{settings:this._settings,onClick:a.hitch(this,"_toolFinished","DELETE")}));this.addChild(this._tools.DELETE);this._settings.toolbarOptions&&
((this._settings.toolbarOptions.cutVisible||this._settings.toolbarOptions.mergeVisible||this._settings.toolbarOptions.reshapeVisible)&&this._createSeparator(),this._settings.toolbarOptions.cutVisible&&(this._tools.CUT=new m({settings:this._settings,onFinished:a.hitch(this,"_toolFinished","CUT"),onClick:a.hitch(this,"_activateTool","CUT",!0),onApplyEdits:a.hitch(this,"onApplyEdits")}),this.addChild(this._tools.CUT)),this._settings.toolbarOptions.mergeVisible&&(this._tools.UNION=new n({settings:this._settings,
onFinished:a.hitch(this,"_toolFinished","UNION"),onApplyEdits:a.hitch(this,"onApplyEdits")}),this.addChild(this._tools.UNION)),this._settings.toolbarOptions.reshapeVisible&&(this._tools.RESHAPING=new p({settings:this._settings,onClick:a.hitch(this,"_activateTool","RESHAPING",!0),onFinished:a.hitch(this,"_toolFinished","RESHAPING"),onApplyEdits:a.hitch(this,"onApplyEdits")}),this.addChild(this._tools.RESHAPING)));this._settings.enableUndoRedo&&(this._createSeparator(),this._tools.UNDO=new b(a.mixin(d.undo,
{settings:this._settings,onClick:a.hitch(this,function(){this._tools.UNDO.set("disabled",!0);this._tools.REDO.set("disabled",!0);this._settings.editor._undo()})})),this.addChild(this._tools.UNDO),this._tools.REDO=new b(a.mixin(d.redo,{settings:this._settings,onClick:a.hitch(this,function(){this._tools.UNDO.set("disabled",!0);this._tools.REDO.set("disabled",!0);this._settings.editor._redo()})})),this.addChild(this._tools.REDO))}});g("extend-esri")&&a.setObject("dijit.editing.toolbars.Drawing",c,t);
return c});